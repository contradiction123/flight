...
<div class="container">
    ...
    <div class="jumbotron Seat">
        ...
        <div class="form-group selectSeat">
            <h1>购票</h1>
                ...
                <div id="user_information">
                    ...
                    <div class="form-group">
                        <label class="checkbox-inline">
                            <input type="checkbox" class="inlineCheckbox1" value="child" name="attribute1"> child
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" class="inlineCheckbox2" value="vip" name="attribute1"> vip
                        </label>
                    </div>

                    <div class="form-group">
                        <label class="checkbox-inline">
                            <input type="checkbox" class="inlineCheckbox3" value="windows" name="attribute2"> windows
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" class="inlineCheckbox4" value="door" name="attribute2"> door
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" class="inlineCheckbox5" value="middle" name="attribute2"> middle
                        </label>
                        <label class="checkbox-inline">
                            <input type="checkbox" class="inlineCheckbox6" value="aisle" name="attribute2"> aisle
                        </label>
                    </div>
                </div>


                <button type="button" class="btn btn-default" id="addUser">添加用户</button>
                <button type="button" class="btn btn-default" id="sumbitbtn">提交</button>
...
<script>
    ...
    document.getElementById("addUser").onclick=function(){
        var html = "";
        html+="<div class=\"form-group\">                    <label>name</label>                    <input type=\"text\" class=\"form-control\" name=\"name\" placeholder=\"name\">                </div>                <div class=\"form-group\">                    <label class=\"checkbox-inline\">                        <input type=\"checkbox\" class=\"inlineCheckbox1\" value=\"child\" name=\"attribute1\"> child                    </label>                    <label class=\"checkbox-inline\">                        <input type=\"checkbox\" class=\"inlineCheckbox2\" value=\"vip\" name=\"attribute1\"> vip                    </label>                </div>                <div class=\"form-group\">                    <label class=\"checkbox-inline\">                        <input type=\"checkbox\" class=\"inlineCheckbox3\" value=\"windows\" name=\"attribute2\"> windows                    </label>                    <label class=\"checkbox-inline\">                        <input type=\"checkbox\" class=\"inlineCheckbox4\" value=\"door\" name=\"attribute2\"> door                    </label>                    <label class=\"checkbox-inline\">                        <input type=\"checkbox\" class=\"inlineCheckbox5\" value=\"middle\" name=\"attribute2\"> middle                    </label>                    <label class=\"checkbox-inline\">                        <input type=\"checkbox\" class=\"inlineCheckbox6\" value=\"aisle\" name=\"attribute2\"> aisle                   </label>                </div>";

        document.getElementById("user_information").innerHTML+=html;
    }


    //点击提交的代码
    document.getElementById("sumbitbtn").onclick=function () {
        //点击了提交按钮 判断是否有蓝色座位——正在分配的位置
        //如果有那就改变为黑色
        seat_black("blue");
        ...
        //child——inlineCheckbox1
        var inlineCheckbox1=document.getElementsByClassName("inlineCheckbox1");
        //vip——inlineCheckbox2
        var inlineCheckbox2=document.getElementsByClassName("inlineCheckbox2");
        //windows——inlineCheckbox3
        var inlineCheckbox3=document.getElementsByClassName("inlineCheckbox3");
        //door——inlineCheckbox4
        var inlineCheckbox4=document.getElementsByClassName("inlineCheckbox4");
        //middle——inlineCheckbox5
        var inlineCheckbox5=document.getElementsByClassName("inlineCheckbox5");
        //aisle——inlineCheckbox6
        var inlineCheckbox6=document.getElementsByClassName("inlineCheckbox6");
        ...
        for(let i=0;i<userName.length;i++){
            ...
            if(inlineCheckbox1[i].checked){
                type[typenum++]+=inlineCheckbox1[i].value;
            }
            if(inlineCheckbox2[i].checked){
                type[typenum++]+=inlineCheckbox2[i].value;
            }
            if(inlineCheckbox3[i].checked){
                type[typenum++]+=inlineCheckbox3[i].value;
            }
            if(inlineCheckbox4[i].checked){
                type[typenum++]+=inlineCheckbox4[i].value;
            }
            if(inlineCheckbox5[i].checked){
                type[typenum++]+=inlineCheckbox5[i].value;
            }
            if(inlineCheckbox6[i].checked){
                type[typenum++]+=inlineCheckbox6[i].value;
            }
            //获取到后在存进passenger_info对象里面
            var jsonObj = {};
            jsonObj["Id"]=userName[i].value;
            jsonObj["type_one"]=type[0];
            jsonObj["type_second"]=type[1];
        ...
        var json1=new Array();
            ...
            j["passenger_num"]=userName.length;//人数
